...
import com.landlordpro.dto.constants.Patterns;
...
public class ApartmentDto {
    ...
    @Pattern(
        regexp = Patterns.APARTMENT_NAME_PATTERN_LETTER_WITHOUT_SPACES,
    ...
    @Pattern(
        regexp = Patterns.NAME_PATTERN_LETTER_AND_SPACES,
    ...
    @Pattern(
        regexp = Patterns.ADDRESS1_PATTERN_LETTER_AND_SPACES,
    ...
    @Pattern(
        regexp = Patterns.ADDRESS2_PATTERN_LETTER_AND_SPACES,
    ...
    @Pattern(
        regexp = Patterns.PINCODE_PATTERN_FOUR_DIGITS,
    ...
    @Pattern(
        regexp = Patterns.CITY_PATTERN_LETTER_AND_SPACES,
